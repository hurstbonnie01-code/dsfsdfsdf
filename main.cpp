...
private:
    ...
    void createGraphicsPipeline() {
        VkShaderModule vertShaderModule = createShaderModule(cube_vert_spv, cube_vert_spv_count);
        VkShaderModule fragShaderModule = createShaderModule(cube_frag_spv, cube_frag_spv_count);
